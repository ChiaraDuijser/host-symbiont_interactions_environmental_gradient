---
title: "Symbiodiniaceae diversity (Sequences, Profiles, PCoA, PERMANOVA)"
...
require("knitr")
opts_knit$set(root.dir = "../Symbiodiniaceae diversity/")
```
...
Metadata now includes an extra column *population* which contains the populations based on STRUCTURE and DAPC analysis. CLONE is included!

```{r}
# Import sequence table
seqs <- read_tsv("../Symbiodiniaceae diversity/20230421T034816_cduijser/post_med_seqs/259_20230421T204816_DBV_20230422T042656.seqs.absolute.abund_and_meta.txt") %>%
...
meta <- read.csv("../Symbiodiniaceae diversity/230423 metadata_species_colony_position_CMD_HYBRID_2.csv", sep=",")
...
profiles_raw <- read_tsv("../Symbiodiniaceae diversity/20230421T034816_cduijser/its2_type_profiles/259_20230421T204816_DBV_20230422T042656.profiles.absolute.abund_and_meta.txt", skip = 6) %>% #first 6 rows is other text
...
#ggsave("../Symbiodiniaceae diversity/profiles_pie_HYBRID_cloneincl2.pdf")
```
...
fasta <- read_fasta_df("../Symbiodiniaceae diversity/20230421T034816_cduijser/post_med_seqs/259_20230421T204816_DBV_20230422T042656.seqs.fasta") %>%
...
# Save the plots
#ggsave("../Symbiodiniaceae diversity/back_Reef_colpos_cloneincl_2.0.pdf", plot = back_Reef_colpos)
#ggsave("../Symbiodiniaceae diversity/back_Mangrove_colpos_cloneincl_2.0.pdf", plot = back_Mangrove_colpos)
#ggsave("../Symbiodiniaceae diversity/back_Hybrid_colpos_cloneincl_2.0.pdf", plot = back_Hybrid_colpos)
```
