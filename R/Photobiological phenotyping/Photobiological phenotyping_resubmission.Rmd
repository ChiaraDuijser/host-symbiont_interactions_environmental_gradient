...
# Remove clones from the dataset that is not yet normalized
dark_params_NOut_clonerem <- dark_params_NOut_clonerem[!(dark_params_NOut_clonerem$sample_id %in% c("5", "6", "7", "8")), ]

## CLONE REMOVAL PCA ###  
### Normalization ###
# apply bestNormalize heuristics
  params_bns_clonerem <- dark_params_NOut_clonerem #bn = bestnormalize, s added to differentiate between Matts and this code
